...
from editor.ui_modules.booklike_text_edit import BooklikeTextEdit
...
class EditorWindow(QStackedWidget):
    ...
    def switchToViewer(self, widget_from_previous_view) -> None:
        self.removeWidget(widget_from_previous_view)
        widget_from_previous_view.deleteLater()    # marks the previous page for deleteon
        self.setCurrentIndex(0)    # force the stack widget to return to the viewer page.
